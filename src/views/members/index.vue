      ...
      >
        <div class="overflow-hidden h-64">
          <img
            ...
            alt="member image"
            class="object-cover h-64 mb-3 hover:scale-110 ease-in duration-200"
          />
        </div>
        <router-link
          :to="{ name: 'members/bio', params: { id: member.id } }"
          class="text-accent-darkest text-lg font-semibold"
        >
          <span class="underline">
            {{ member.title }}
          </span>
          <p class="text-accent-text-grey">{{ member.role }}</p>
        </router-link>
          ...
          <a href="#" class="cursor-pointer">
            ...
            >
              <path
                ...
                fill="currentColor"
                class="fill-accent hover:fill-accent-hover transition"
              />
            </svg> </a
          ><a href="#">
            <svg
